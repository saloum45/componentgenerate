...
const edit_ts_1 = require("../../templates/edit/edit.ts");
const edit_html_1 = require("../../templates/edit/edit.html");
    ...
    return (tree) => {
        ...
        return (0, schematics_1.chain)([
            ...
            (tree, _context) => {
                ...
                (0, edit_html_1.get_html_content)(table));
                ...
                (0, edit_ts_1.get_ts_content)(table, componentName_class, componentName, tafConfig));
            }
        ]);
    };
}
